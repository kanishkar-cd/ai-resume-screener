...
class AssessmentHandoffRequest(APIModel):
    ...
    provider: str = Field(default="gmail", description="Email provider to use: 'gmail' or 'outlook'")
    ...
    def validate_provider(cls, v: str) -> str:
        ...
        if v_clean not in ("gmail", "outlook"):
            raise ValueError(f"Invalid email provider '{v}'. Allowed providers are 'gmail' and 'outlook'.")
        return v_clean
