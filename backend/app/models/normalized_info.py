...
class NormalizedResumeModel(UUIDMixin, TimestampMixin, Base):
    ...
    total_experience_months: Mapped[int] = mapped_column(nullable=False, default=0, server_default=text("0"))
    candidate_level: Mapped[str] = mapped_column(String(32), nullable=False, default="FRESHER", server_default=text("'FRESHER'"))
